            ...
            <div class="login_box">
                ...
                ?>
                    ...
                    <form method="POST" action="Login_Backend.php"> 
                        ...
                        <div class = "row4c2">
                            <input type = "button" class = "forgot" value = "Forgot Password?" onclick="redirectToForgotPassword()">
                        </div>
                    ...
                    <script>
                        ...
                        function redirectToSignUp() {
                            window.location.href = "https://se-prod.cse.buffalo.edu/CSE442/2024-Fall/cse-442m/Workout_Register/CreateAccount.php";
                        }

                        function redirectToForgotPassword() {
                            // header("Location: https://se-dev.cse.buffalo.edu/CSE442/2024-Fall/dashawne/Forgot_Password/ResetSuccessConfirmation.php");
                            window.location.href = "https://se-prod.cse.buffalo.edu/CSE442/2024-Fall/cse-442m/Workout_Forgot/ForgotPasswordPage.php";
                        }
                        ...
                        function checkAuthToken() {
                            let token = getCookie('Authentication_Token');
                            if (token) {
                                window.location.href = "Location: https://se-prod.cse.buffalo.edu/CSE442/2024-Fall/cse-442m/Workout_Landing/Landing_Page.php";
                            } else {
                                console.log("auth_token not found, please log in.");
                            }
                        }
