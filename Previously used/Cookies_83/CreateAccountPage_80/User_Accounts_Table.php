...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "INSERT INTO `User_Accounts_Table`(`Email`, `Username`, `Password`, `id`) VALUES ('$email', '$username', '$hashedPassword', '$id')";
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            header("Location: https://se-dev.cse.buffalo.edu/CSE442/2024-Fall/dashawne/Login_Token/LoginPage_68/Login.php?corr=Account Created Successfully!");
