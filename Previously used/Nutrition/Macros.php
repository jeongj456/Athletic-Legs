            ...
            <div class="top-of-page">
                <div class="hamburger-menu">
                    ...
                    <div class="nav-menu" id="navMenu">
                        <a href="#">Home</a>
                        <a
                            href="https://se-prod.cse.buffalo.edu/CSE442/2024-Fall/cse-442m/Workout_ProfilePage/Profile.php">Profile</a>
                        <a
                            href="https://se-prod.cse.buffalo.edu/CSE442/2024-Fall/cse-442m/Workout_PlannedWorkouts/PlannedWorkout.php">Planned
                            Workout</a>
                        <a
                            href="https://se-prod.cse.buffalo.edu/CSE442/2024-Fall/cse-442m/Workout_SharedWorkouts/sharedworkouts.php">Shared
                            Workouts</a>
                        <a
                            href="https://se-prod.cse.buffalo.edu/CSE442/2024-Fall/cse-442m/Workout_History/WorkoutHistory.php">Workout
                            History</a>
                        <a
                            href="https://se-prod.cse.buffalo.edu/CSE442/2024-Fall/cse-442m/Workout_MacroPage/Macros.php">Macronutrients</a>
                        <a
                            href="https://se-prod.cse.buffalo.edu/CSE442/2024-Fall/cse-442m/Workout_Stats/WorkoutStats.php">My
                            Stats</a>
                        <a
                            href="https://se-prod.cse.buffalo.edu/CSE442/2024-Fall/cse-442m/Workout_Friends/Friends.php">Friends</a>
                ...
                <div class="team-name">
                    <a href="https://se-prod.cse.buffalo.edu/CSE442/2024-Fall/cse-442m/Workout_ProfilePage/Profile.php"
                        style="color:white; text-decoration: none;">Athletic Legs</a>
                </div>
                ...
                <div class="made-buttons" id="users-macro">
                    ...
                    $query = "SELECT * FROM macro WHERE username = '$username'";
                    ...
                    if ($result->num_rows == 1) {
                        ...
                        $protein = $row['protein'];
                        $fat = $row['fat'];
                        echo "<a href='macrosPieChart.php?calories=$calories&carbs=$carbs&protein=$protein&fat=$fat&inp=0' style='color:black;text-decoration: none;'>Current Macros</a>";
                ...
                <div class="bottom-container">
                            ...
                            <div class="user-inputs" id="genders">
                                ...
                                <div class="gender-buttons">
                                    ...
                                    <div class="made-buttons" id="prefer-not-to-say">
                                        <input type="radio" id="prefer-not-to-say-button" name="genders"
                        ...
                        <div class="user-inputs" id="lifestyle">
                            ...
                            <div class="lifestyle-buttons">
                                <div class="made-buttons" id="sedintary">
                                    <input type="radio" id="sedintary-button" name="lifestyle-choices"
                                        value="sedintary">
                                    <label for="sedintary-button">Sedintary</label>
                                </div>
                                <div class="made-buttons" id="semi-active">
                                    <input type="radio" id="semi-active-button" name="lifestyle-choices"
                                        value="semi-active">
                                ...
                                <div class="made-buttons" id="very-active">
                                    <input type="radio" id="very-active-button" name="lifestyle-choices"
                                        value="very-active">
                            ...
                            <div class="user-inputs" id="diet">Type of Diet
                                <div class="diet-buttons">
                                    ...
                                    <div class="made-buttons" id="maintenance">
                                        <input type="radio" id="maintenance-button" name="diet-choices"
                                            value="maintenance">
                    ...
                    <div class="right-container">
                        <div class="info-box" id="what-are-macros">What are Macronutrients?
                            <div id="macro-info"><a
                                    href="https://www.forbes.com/health/nutrition/what-are-macros/">Macronutrients</a>
                                are comprised of carbohydrates, fats and proteins—the three types of essential nutrients
                                we consume in the largest quantities that account for daily calorie intake. While each
                                macronutrient functions differently in the body, all three contribute to generating
                                energy (calories) and are necessary elements of nutrition.</div>
                        </div>
                        <div class="info-row">
                            <div class="info-box" id="carbs">Carbohydrates can be broken down into three
                                subcategories—sugars, starches and <a
                                    href="https://www.forbes.com/health/nutrition/best-fiber-snacks/">fiber</a>—all of
                                which are important for overall health. Sugars and starches are converted into glucose
                                that the body uses for energy. Meanwhile, fiber isn't broken down by the body and
                                instead may contribute to healthy digestion in the form of stool regularity, as well as
                                normal <a
                                    href="https://www.forbes.com/health/wellness/healthy-cholesterol-levels/">cholesterol
                                    levels</a>.</div>
                            <div class="info-box" id="fats">Fats are another important source of dietary energy and aid
                                in the absorption of certain fat soluble <a
                                    href="https://www.forbes.com/health/supplements/best-vitamins-for-energy/">vitamins</a>,
                                such as A, <a href="https://www.forbes.com/health/supplements/vitamin-d-guide/">D</a>, E
                                and K. Dietary fats are organized into two subgroups: saturated fats and unsaturated
                                fats. Research suggests that saturated fat should comprise no more than 6% of total fats
                                consumed. Alternatively, consuming unsaturated fats may help lower cholesterol levels.
                            </div>
                            <div class="info-box" id="protein"><a
                                    href="https://www.forbes.com/health/nutrition/how-much-protein-do-you-need/">Protein</a>
                                contains amino acids, which are vital building blocks for many bodily functions. In
                                addition to producing energy, protein is an important nutrient for collagen production,
                                which helps build and repair muscles and bones, and it helps regulate the functions of
                                protein hormones like insulin. Myriad plant and animal food sources provide protein,
                                such as chicken, beans and eggs.</div>
                        </div>
                    </div>
                </div>
            </div>
