                        ...
                        <?php 
                            ...
                            if ($result) {
                                while ($row = $result->fetch_assoc()){
                                    ...
                                    $protein = $row['protein'];
                                    $fat = $row['fat'];
                                    echo"<div id='users-macro'><a href='https://se-prod.cse.buffalo.edu/CSE442/2024-Fall/cse-442m/Workout_MacroPage/macrosPieChart.php?calories=$calories&carbs=$carbs&protein=$protein&fat=$fat&inp=0'>Current Macros</a></div>";
                                    break;
                                }
                            }
                        ?>
