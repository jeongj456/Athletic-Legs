...
if(empty($_POST["genders"])){
  echo "<script type='text/javascript'>alert('Return to previous page and please select a gender'); history.back();</script>";
  die();
}elseif(empty($_POST["age"])){
  echo "<script type='text/javascript'>alert('Return to previous page and please enter your age'); history.back();</script>";
  die();
}elseif(empty($_POST["height"])){
  echo "<script type='text/javascript'>alert('Return to previous page and please enter your height'); history.back();</script>";
  die();
}elseif(empty($_POST["weight"])){
  echo "<script type='text/javascript'>alert('Return to previous page and please enter your weight'); history.back();</script>";
  die();
}elseif(empty($_POST["lifestyle-choices"])){
  echo "<script type='text/javascript'>alert('Return to previous page and please select a lifestyle'); history.back();</script>";
  die();
}elseif(empty($_POST["diet-choices"])){
  echo "<script type='text/javascript'>alert('Return to previous page and please select a type of diet'); history.back();</script>";
  die();
}
