    ...
    <div class="heading_box">
        ...
        <div class="background_box">
            ...
            <div class = "column1">
                ...
                <div class = "row2c1">
                    <h1 class = "sub_title">Re-enter your new password</h1>
                </div>
                ...
                <form method="POST" action="ConfirmNewPassword.php"> 
                    
                    <div class = "br"></div>

                    <div class = "row2c1">
                        <input type = "password" placeholder="Re-enter Password" class = "input-fields" required name="password">
                    </div>
                    ...
                    <div class = "row4c1">
                        <input type = "submit" class = "create" value = "Reset Password" id = "passwordInput">
                    </div>
                ...
                <script>
                    ...
                    function redirectToSuccess() {
                        ...
                        const emailInput = document.getElementById('passwordInput').value;

                        if (emailInput.trim() === '') {
                            toggleMenu();  // Show error message
                        } else {
                            window.location.href = 'https://se-prod.cse.buffalo.edu/CSE442/2024-Fall/cse-442m/Workout_Forgot/ResetSuccessConfirmation.php';
                        }
                    }
