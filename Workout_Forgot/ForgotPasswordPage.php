...
<body>
        ...
        <div class="background_box">
            ...
            <div class = "column1">
                ...
                <div class = "row2c1">
                    <h1 class = "sub_title">Enter your email to reset your password.</h1>
                </div>
                ...
                <form method="POST" action="Send_Email.php"> 
                    ...
                    <div class = "row2c1">
                        <input type = "email" placeholder="Enter Email" class = "input-fields" required name="email" id="emailInput">
                    </div>
                    ...
                    <div class = "row4c1">
                        <input type = "submit" class = "create" onclick="redirectToForgotPassword()" value = "Forgot Password" id = "emailInput">
                    </div>
                ...
                <script>
                    ...
                    function redirectToForgotPassword() {
                        ...
                        if (emailInput.trim() === '') {
                            toggleMenu();  // Show error message
                        } else {
                            window.location.href = 'https://se-prod.cse.buffalo.edu/CSE442/2024-Fall/cse-442m/Workout_Forgot/LinkConfirmation.php';
                        }

                        // window.location.href = 'https://se-dev.cse.buffalo.edu/CSE442/2024-Fall/dashawne/Forgot_Password/LinkConfirmation.php';
                    }
