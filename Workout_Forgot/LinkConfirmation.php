    ...
    <div class="heading_box">
        ...
        <div class="background_box">
            ...
            <div class = "column1">
                ...
                <div class = "row2c1">
                    <h1 class = "sub_title">The link to reset your password has been sent to your email</h1>
                </div>
                ...
                <form action="User_Accounts_Table.php" method="POST"> 
                    ...
                    <div class = "row4c1">
                        <input type = "button" class = "create" value = "Ok" onclick="redirectToLogin()">
                    </div>
