...
<head>
    <title>Create Your Account Page</title>
        ...
        <div class="background_box">
            ...
            <div class = "column1">
                ...
                echo '<div class="alert2">
                    <span class="closebtn" onclick="window.location.href=\'../Workout_Login/Login.php\'">&times;</span>' 
                ...
                <form action="User_Accounts_Table.php" method="POST"> 
                    ...
                    <div class = "row2c1">
                        <input type = "email" placeholder="Enter Email" class = "input-fields" required name="email">
                    </div>
                    ...
                    <div class = "row4c1">
                        <input type = "Submit" class = "create" value = "Create Your Account">
                    </div>
