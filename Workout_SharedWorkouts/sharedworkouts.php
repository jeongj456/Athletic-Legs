...
<head>
    ...
    <link rel="stylesheet" media="screen and (max-width: 722px)" href="sharedworkouts_mobile.css">
    <link rel="stylesheet" media="screen and (min-width: 723px)" href="sharedworkouts.css">
</head>
        ...
        <div class="content">
            <div class="top">
                ...
                <div class=actionBtns>
                    <div class="made-buttons">
                        <a href="incomingworkouts.php">
                            Incoming Workouts
                        </a>
                    </div>

                    <div>
                        <button class="made-buttons" onclick="openBlockModal()">
                            Block a User
                        </button>
                    </div>
                </div>
